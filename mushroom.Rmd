...
### Model Fitting
The data is split into a training set and a test set. In addition, the training data is split into six-folds in preperation for cross-validation.
```{r}
set.seed(7)
...
Next, I specified the model and tuned the parameter 'trees'. The optimal number of trees was found to be 50.
